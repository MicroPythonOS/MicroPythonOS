"""
Test that LightsOut uses lv.msgbox() for its confirmation popup.
...
class TestLightsOutConfirmPopup(unittest.TestCase):
    """Verify the LightsOut confirmation popup uses lv.msgbox()."""
    ...
    def test_new_game_opens_msgbox(self):
        ...
        result = AppManager.start_app("com.micropythonos.lights_out")
        self.assertTrue(result, "LightsOut should start")
        wait_for_render(10)
