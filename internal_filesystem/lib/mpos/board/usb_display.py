...
# width/height 0,0 = EDID auto. Never request below 640x480: smaller modes
# need a sub-25MHz pixel clock that real monitors cannot sync to (verified).
def try_init_usb_display(width=0, height=0, timeout_s=10, buf_lines=16):
    import usb_disp
