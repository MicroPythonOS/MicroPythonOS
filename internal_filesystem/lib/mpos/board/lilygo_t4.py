...
print("lilygo_t4.py init buzzer")
...
print("lilygo_t4.py init battery monitoring")
VOLTAGE_REF = 3.6
DIVIDER_RATIO = 2.0
...
print("lilygo_t4.py init SPI sdcard")
try:
    ...
    print(f"Error initializing sdcard SPI bus: {e}")
