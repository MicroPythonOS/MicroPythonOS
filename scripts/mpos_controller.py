...
def _build_test_code(test_path, tests_dir=None):
    ...
    code += "    import lvgl as _lv\n"
    code += "    import mpos.ui.testing as _tst\n"
    code += "    _tst_orig_setup = _tst.GraphicalTestCase.setUp\n"
    code += "    def _tst_patched_setup(self):\n"
    code += "        _tst_orig_setup(self)\n"
    code += "        g = _lv.group_get_default()\n"
    code += "        if g:\n"
    code += "            g.remove_all_objs()\n"
    code += "    _tst.GraphicalTestCase.setUp = _tst_patched_setup\n"
    code += "except Exception as _tst_e:\n"
    code += "    import sys; sys.stderr.write('_tst_patch_setup failed: ' + str(_tst_e) + '\\n')\n"
    code += "    pass\n"
